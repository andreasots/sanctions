...
CREATE INDEX idx_j_req_recovery ON quartz.job_details (sched_name, requests_recovery);
CREATE INDEX idx_j_grp ON quartz.job_details (sched_name, job_group);

CREATE INDEX idx_t_j ON quartz.triggers (sched_name, job_name, job_group);
CREATE INDEX idx_t_jg ON quartz.triggers (sched_name, job_group);
CREATE INDEX idx_t_c ON quartz.triggers (sched_name, calendar_name);
CREATE INDEX idx_t_g ON quartz.triggers (sched_name, trigger_group);
...
CREATE INDEX idx_t_nft_misfire ON quartz.triggers (sched_name, misfire_instr, next_fire_time);
...
CREATE INDEX idx_ft_trig_inst_name ON quartz.fired_triggers (sched_name, instance_name);
CREATE INDEX idx_ft_inst_job_req_rcvry ON quartz.fired_triggers (sched_name, instance_name, requests_recovery);
CREATE INDEX idx_ft_j_g ON quartz.fired_triggers (sched_name, job_name, job_group);
CREATE INDEX idx_ft_jg ON quartz.fired_triggers (sched_name, job_group);
CREATE INDEX idx_ft_t_g ON quartz.fired_triggers (sched_name, trigger_name, trigger_group);
CREATE INDEX idx_ft_tg ON quartz.fired_triggers (sched_name, trigger_group);
